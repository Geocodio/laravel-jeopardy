...
test('generates game board with categories and clues', function () {
    ...
    expect($categoryNames)->toContain('Taylor\'s Version');
    expect($categoryNames)->toContain('404: Category Not Found');
    expect($categoryNames)->toContain('Laracon Legends');
    expect($categoryNames)->toContain('Rød Grød Med Fløde');
    expect($categoryNames)->toContain('Breaking Prod');
    expect($categoryNames)->toContain('Eloquently Speaking');
