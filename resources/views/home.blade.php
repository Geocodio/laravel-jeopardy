...
<body
    class="font-sans antialiased bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 text-white min-h-screen flex items-center justify-center overflow-hidden">
<!-- Animated Background -->
<div class="absolute inset-0 overflow-hidden">
    <div class="absolute -inset-10 opacity-30">
        <div
            class="absolute top-0 -left-4 w-72 h-72 bg-purple-500 rounded-full mix-blend-multiply filter blur-xl animate-blob"></div>
        <div
            class="absolute top-0 -right-4 w-72 h-72 bg-yellow-500 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-2000"></div>
        <div
            class="absolute -bottom-8 left-20 w-72 h-72 bg-pink-500 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-4000"></div>
    </div>
</div>

<div class="relative z-10 text-center px-4" x-data="{ showContent: false }"
    ...
    <div x-show="showContent"
        ...
        <div class="flex justify-center mb-10">
            <svg class="w-full max-w-md h-auto" width="1280" height="308" viewBox="0 0 1280 308" fill="currentColor"
...
<div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-sm opacity-50"
    ...
    <p class="text-white/50">
        Made with ❤ and 🤖 for Laravel Live Denmark
        <button onclick="new Audio('/sounds/countdown.wav').play()"
                class="cursor-pointer ml-2 underline hover:text-white transition-colors">
            🔊 Test Audio
        </button>
    </p>
</div>
