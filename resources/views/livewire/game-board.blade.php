<div x-data="{ mounted: false, selectedCategory: null }" x-init="setTimeout(() => mounted = true, 200)"
    ...
    @if($game)
        ...
        <div class="fixed inset-0 overflow-hidden pointer-events-none"
            ...
            <!-- Gradient Orbs -->
            <div
                class="absolute top-20 left-20 w-96 h-96 bg-purple-500/30 rounded-full filter blur-3xl animate-blob"></div>
            <div
                class="absolute top-40 right-20 w-96 h-96 bg-pink-500/30 rounded-full filter blur-3xl animate-blob animation-delay-2000"></div>
            <div
                class="absolute bottom-20 left-1/2 w-96 h-96 bg-indigo-500/30 rounded-full filter blur-3xl animate-blob animation-delay-4000"></div>
        </div>
        ...
        <div class="relative container mx-auto px-4 py-6"
            ...
            <div class="text-center mb-6">
                <div class="flex flex-col items-center gap-4">
                    ...
                    <svg class="w-64 h-16"
                         ...
                         width="1280" height="308" viewBox="0 0 1280 308" fill="currentColor"
                    ...
                    <!-- Jeopardy Text -->
                    <h1 class="text-5xl md:text-6xl font-geoparody font-bold text-yellow-400 tracking-[0.3em]"
                        x-show="mounted"
                        x-transition:enter="transition ease-out duration-[2000ms] delay-[1500ms]"
                        x-transition:enter-start="opacity-0 translate-y-8 scale-95"
                        x-transition:enter-end="opacity-100 translate-y-0 scale-100">
                        JEOPARDY
                    </h1>
            ...
            <div class="max-w-7xl mx-auto mt-6">
                ...
                <div class="grid grid-cols-6 gap-3 mb-3">
                    @foreach($categories as $index => $category)
                        <div class="group perspective-1000"
                            ...
                            <div
                                class="absolute -inset-1 bg-gradient-to-r from-yellow-400 to-orange-400 rounded-xl opacity-0 group-hover:opacity-75 blur-sm transition-opacity duration-300"></div>
                ...
                <div class="grid grid-cols-6 gap-3">
                    @foreach([100, 300, 500, 1000] as $rowIndex => $value)
                                ...
                                <div class="group perspective-1000">
                                    ...
                                    <div class="relative h-24 md:h-28 lg:h-32 rounded-xl flex items-center justify-center transform transition-all duration-300 preserve-3d
                                        ...
                                        @if(!$clue->is_answered)
                                            ...
                                            <div class="relative">
                                                <div
                                                    class="text-4xl md:text-5xl lg:text-5xl font-black text-yellow-400 drop-shadow-[0_4px_8px_rgba(0,0,0,0.9)]">
                                                    ${{ $value }}
                                                </div>
                                            </div>
                                        @else
                                            ...
                                            <div class="text-gray-600">
                                                <svg class="w-8 h-8 md:w-10 md:h-10" fill="currentColor"
                                                     viewBox="0 0 20 20">
