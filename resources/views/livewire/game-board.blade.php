<div x-data="{ mounted: false, selectedCategory: null }" x-init="setTimeout(() => mounted = true, 200)" class="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900">
    @if($game)
        <script>
            ...
            <div class="text-center mb-6">
                <div class="flex flex-col items-center gap-4">
                    ...
                    <svg class="w-64 h-16" 
                         ...
                         width="1280" height="308" viewBox="0 0 1280 308" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
